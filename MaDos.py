...
while (True):
    ...
    if (code == "help"):
        ...
        if (what == "cmds"):
            print("Commands are: payam, cls, exit, shutdown, pause, spam, color, files, sendkey, help, PNINSTL, start, vol, mkdir, taskkill, date, update, mapyter, cmd, time, diskpart, cd, tasklist, compressed, certreq, getmac, host, klist, mountvol, msinfo, rdc, qwinsta, sxstrace, vssadmin")
    ...
    if (code == "mados --uninstall"):
        print("Uninstalling MaDos! Close program to cancel!")
        time.sleep(15)
